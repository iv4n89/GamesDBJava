...
public class CategoryController {
    ...
    public CategoryDto updateCategory(@PathVariable("id") long id,
        ...
        Category entity = convertToEntity(category);
        Category _category = this.service.updateCategory(id, entity);
        return convertToDto(_category);
    }
    ...
    public CategoryDto addConsoleToCategory(@PathVariable("id") long id, @PathVariable("consoleId") long consoleId) {
        Console console = this.consoleService.getOneConsole(consoleId);
        Category category = this.service.getOneCategory(consoleId)
    }
